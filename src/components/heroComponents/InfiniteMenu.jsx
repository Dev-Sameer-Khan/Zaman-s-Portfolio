...
export default function InfiniteMenu({ items = [] }) {
  ...
  return (
    <div className="relative w-full h-full will-change-transform bg-black/50">
      <canvas
        id="infinite-grid-menu-canvas"
        ref={canvasRef}
        className="cursor-grab w-full h-full bg-black/50 overflow-hidden relative outline-none active:cursor-grabbing"
      />
